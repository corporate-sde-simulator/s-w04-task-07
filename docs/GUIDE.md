...
> **Welcome to Service-Track Week 4, Task 7!**
...
| `src/channelRouter.ts` | Main source code - **has bugs to fix** |
| `src/preferenceManager.ts` | Supporting code - **may also have bugs** |
| `tests/preferenceManager.test.ts` | Test file - **add your tests here** |
